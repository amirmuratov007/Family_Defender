...
- `desktop/` - temporary Windows desktop simulator with Russian/English language choice for testing parent/child flows before Mac and iPhone testing.
...
- `desktop/README_RU.md`, `desktop/README_EN.md` - Windows desktop simulator instructions.
