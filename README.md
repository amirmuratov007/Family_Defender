...
- `desktop/` - temporary Windows desktop simulator for testing parent/child flows before Mac and iPhone testing.
...
- `desktop/README_RU.md` - Windows desktop simulator instructions.
